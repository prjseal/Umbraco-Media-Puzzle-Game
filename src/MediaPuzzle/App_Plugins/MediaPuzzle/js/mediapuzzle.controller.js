angular.module("umbraco")
    .controller("MediaPuzzle", function ($scope, editorState) {

        var mediaUrl = "/App_Plugins/MediaPuzzle/assets/bl.jpg";

        if (editorState.current.contentType.alias === "Image") {
            mediaUrl = editorState.current.mediaLink + "?width=800&height=640&mode=crop&anchor=center";
        }

        var game = new Phaser.Game(800, 640, Phaser.CANVAS, 'media-puzzle', { preload: preload, create: create });
        ...
        function preload() {
            game.load.spritesheet("background", mediaUrl, PIECE_WIDTH, PIECE_HEIGHT);
        }

        function create() {
            prepareBoard();
            game.stage.backgroundColor = "#413659";
        }
